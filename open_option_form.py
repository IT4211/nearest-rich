...
class Ui_Open_Option(object):
    ...
    def retranslateUi(self, Open_Option):
        ...
        self.groupBox.setTitle(_translate("Open_Option", "File extension", None))
